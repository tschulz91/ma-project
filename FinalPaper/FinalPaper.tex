...
\begin{document}
	...
	statistics are categorised by
  	...
  	The data together with the Python scripts that were used to download and aggregate the hourly data files can be found at \url{https://github.com/timschulz91/ma-project}. Also included here are the R scripts that were used for modelling and analyzing the data.
